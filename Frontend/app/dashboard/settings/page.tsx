      ...
      <Tabs defaultValue="account" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[300px] flex items-center justify-center border rounded-md">
                <p className="text-muted-foreground">Team management interface</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="billing" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-[300px] flex items-center justify-center border rounded-md">
                <p className="text-muted-foreground">Billing management interface</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium">Build Alerts</p>
                    <p className="text-sm text-muted-foreground">Get notified about build issues</p>
                  </div>
                  <Switch defaultChecked />
                </div>
        ...
        <TabsContent value="api" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-[300px] flex items-center justify-center border rounded-md">
                <p className="text-muted-foreground">API key management interface</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
