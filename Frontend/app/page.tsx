        ...
        <section className="py-20 md:py-28 lg:py-32 container">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
              Connect your GitHub repository and we'll handle the entire DevOps pipeline. Build, test, deploy, and scale
            ...
            <div className="relative w-full h-[300px] md:h-[400px] mt-12 rounded-lg overflow-hidden border bg-muted/40">
